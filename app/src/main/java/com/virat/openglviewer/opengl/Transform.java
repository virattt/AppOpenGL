...
public class Transform {
  ...
  private float[] preTranslation = new float[]{0f, 0f, 0f};
  ...
  public void preTranslate(float[] preTranslation) {
  ...
  public float[] localToWorldMatrix() {
    ...
    // Pre-translate (i.e. move to origin)
    translateM(modelMatrix, 0, preTranslation[0], preTranslation[1], preTranslation[2]);
